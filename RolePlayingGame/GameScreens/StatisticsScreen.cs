    ...
    class StatisticsScreen : GameScreen
    {
        ...
        private void DrawButtons()
        {
            ...
            if (Session.Party.Players.Contains(player))
            {
                ...
                spriteBatch.DrawString(Fonts.MainFont, "Quest", position,
                    Color.Black);
                ...
                position.X += (leftTriggerButton.Width / 2) - placeTextMid.X / 2;
                spriteBatch.DrawString(Fonts.MainFont, "Items", position,
                    Color.Black);
            }
            ...
            position.Y += 5;
            spriteBatch.DrawString(Fonts.MainFont, "Spellbook", position,
                Color.White);
            ...
            position.Y += 5;
            spriteBatch.DrawString(Fonts.MainFont, "Back", position,
                Color.White);
            ...
            position.Y += 5;
            spriteBatch.DrawString(Fonts.MainFont, "Equipment", position,
                Color.White);
        ...
        private void DrawPlayerDetails()
        {
            ...
            if (player != null)
            {
                ...
                // Magic Points
                currentTextPosition.Y += intervalBetweenEachInfo;
                spriteBatch.DrawString(Fonts.MainFont, "Magic Points: " +
                ...
                {
                    spriteBatch.DrawString(Fonts.MainFont, "Experience: Maximum",
                        currentTextPosition, Color.Black);
                }
                else
                {
                    spriteBatch.DrawString(Fonts.MainFont, "Experience: " +
                        player.Experience + "/" +
        ...
        private void DrawModifiers(Player selectedPlayer)
        {
            ...
            // PO + Modifiers
            spriteBatch.DrawString(Fonts.MainFont, "Physical Offense: " +
                selectedPlayer.CurrentStatistics.PhysicalOffense,
                currentTextPosition, Color.Black);

            // PD + Modifiers
            currentTextPosition.Y += intervalBetweenEachInfo;
            spriteBatch.DrawString(Fonts.MainFont, "Physical Defense: " +
                selectedPlayer.CurrentStatistics.PhysicalDefense,
                currentTextPosition, Color.Black);

            // MO + Modifiers
            currentTextPosition.Y += intervalBetweenEachInfo;
            spriteBatch.DrawString(Fonts.MainFont, "Magical Offense: " +
                selectedPlayer.CurrentStatistics.MagicalOffense,
                currentTextPosition, Color.Black);

            // MD + Modifiers
            currentTextPosition.Y += intervalBetweenEachInfo;
            spriteBatch.DrawString(Fonts.MainFont, "Magical Defense: " +
        ...
        private void DrawEquipmentStatistics(Player selectedPlayer)
        {
            ...
            spriteBatch.DrawString(Fonts.MainFont, "Weapon Attack: " + "(" +
                healthDamageRange.Minimum + "," +
                healthDamageRange.Maximum + ")",
                position, Color.Black);

            position.Y += 130;
            spriteBatch.DrawString(Fonts.MainFont, "Weapon Defense: " + "(" +
                healthDefenseRange.Minimum + "," +
                healthDefenseRange.Maximum + ")",
                position, Color.Black);

            position.Y += 30;
            spriteBatch.DrawString(Fonts.MainFont, "Spell Defense: " + "(" +
