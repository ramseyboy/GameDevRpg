    ...
    class InnScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            namePosition = new Vector2(
                (viewport.Width - Fonts.MainFont.MeasureString(inn.Name).X) / 2, 90f);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(Fonts.MainFont, inn.Name, namePosition,
                Fonts.DisplayColor);
            ...
            if (selectionMark == 1)
            {
                ...
                spriteBatch.DrawString(
                    Fonts.MainFont, stayString, stayPosition, Fonts.HighlightColor);
                spriteBatch.DrawString(
                    Fonts.MainFont, leaveString, leavePosition, Fonts.DisplayColor);
            }
            else
            {
                ...
                spriteBatch.DrawString(Fonts.MainFont, stayString, stayPosition,
                    Fonts.DisplayColor);
                spriteBatch.DrawString(Fonts.MainFont, leaveString, leavePosition, 
            ...
            spriteBatch.DrawString(
                Fonts.MainFont, selectString, selectTextPosition, Color.White);
            // Draw the back button text
            spriteBatch.DrawString(Fonts.MainFont, backString, backTextPosition,
                Color.White);
            ...
            spriteBatch.DrawString(Fonts.MainFont, costString, costPosition,
                Color.DarkRed);
            // Draw the innkeeper dialog
            for (int i = 0; i < endIndex; i++)
            {
                spriteBatch.DrawString(Fonts.MainFont, currentDialogue[i],
