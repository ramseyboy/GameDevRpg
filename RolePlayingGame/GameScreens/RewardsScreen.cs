...
/// </summary>
internal class RewardsScreen : GameScreen
{
    ...
    /// </summary>
    private readonly RewardScreenMode mode;
    ...
    private readonly List<Gear> gearReward;
    ...
    /// </summary>
    public RewardsScreen(RewardScreenMode mode,
        int experienceReward,
        int goldReward,
        List<Gear> gearReward)
    {
        IsPopup = true;
        this.mode = mode;
        ...
        Exiting += RewardsScreen_Exiting;
    }


    private void RewardsScreen_Exiting(object sender, EventArgs e)
    {
