...
namespace RolePlaying
{
    ...
    class EquipmentScreen : ListScreen<Equipment>
    {
            ...
            bool isSelected)
        {
            ...
            Vector2 powerTextSize = Fonts.MainFont.MeasureString(powerText);
            Vector2 powerPosition = drawPosition;
            powerPosition.Y -= (float)Math.Ceiling((powerTextSize.Y - 30f) / 2);
            spriteBatch.DrawString(Fonts.MainFont, powerText,
                powerPosition, color);
            ...
            if (entry is Weapon)
            {
                spriteBatch.DrawString(Fonts.MainFont, "Weapon", 
                    drawPosition, color);
            }
            else if (entry is Armor)
            {
                Armor armor = entry as Armor;
                spriteBatch.DrawString(Fonts.MainFont, armor.Slot.ToString(),
                    drawPosition, color);
            }
        ...
        protected override void DrawSelectedDescription(Equipment entry)
        {
            ...
            {
                spriteBatch.DrawString(Fonts.MainFont, text, position,
        ...
        protected override void DrawColumnHeaders()
        {
            ...
            {
                spriteBatch.DrawString(Fonts.MainFont, nameColumnText, position,
                    Fonts.CaptionColor);
            }
            ...
            {
                spriteBatch.DrawString(Fonts.MainFont, powerColumnText, position,
                    Fonts.CaptionColor);
            }
            ...
            {
                spriteBatch.DrawString(Fonts.MainFont, slotColumnText, position,
                    Fonts.CaptionColor);
            }
        }
