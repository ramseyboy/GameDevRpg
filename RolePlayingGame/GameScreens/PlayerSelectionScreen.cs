...
namespace RolePlaying
{
    ...
    class PlayerSelectionScreen : GameScreen
    {
        ...
        private void DrawPlayerDetails(Player player, bool isSelected)
        {
            ...
            spriteBatch.DrawString(Fonts.MainFont, player.CharacterClass.Name,
            ...
            spriteBatch.DrawString(Fonts.MainFont, text, equipEffectPosition,
                Fonts.CountColor);
            ...
            spriteBatch.DrawString(Fonts.MainFont, text,
            ...
            spriteBatch.DrawString(Fonts.MainFont, ")", equipEffectPosition,
                Fonts.CountColor);
            ...
            ref Vector2 position)
        {
            ...
            spriteBatch.DrawString(Fonts.MainFont, "HP: " +
            ...
            spriteBatch.DrawString(Fonts.MainFont, "MP: " +
            ...
            spriteBatch.DrawString(Fonts.MainFont, "PO: " +
            ...
            spriteBatch.DrawString(Fonts.MainFont, "PD: " +
            ...
            spriteBatch.DrawString(Fonts.MainFont, "MO: " +
            ...
            spriteBatch.DrawString(Fonts.MainFont, "MD: " +
        ...
        private void DrawButtons()
        {
            ...
            if (isUseAllowed && !isGearUsed)
            {
                ...
                spriteBatch.DrawString(Fonts.MainFont, selectText, position,
                    Color.White);
            }
