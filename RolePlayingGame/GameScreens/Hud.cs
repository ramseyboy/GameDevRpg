...
internal class Hud
{
    ...
    private readonly Vector2 topHudPosition = new(353f, 30f);
    ...
    private readonly Vector2 actionTextPosition = new(640f, 55f);
    private readonly Vector2 backgroundHudPosition = new(0f, 525f);
    ...
    private void DrawForCombat()
    {
        ...
        foreach (var combatantPlayer in CombatEngine.Players)
        {
        ...
        {
            spriteBatch.Draw(charSelArrowLeftTexture,
                charSelLeftPosition,
                Color.White);
            spriteBatch.Draw(charSelArrowRightTexture,
                charSelRightPosition,
                Color.White);
        }
        else
        {
            spriteBatch.Draw(charSelFadeLeftTexture,
                charSelLeftPosition,
                Color.White);
            spriteBatch.Draw(charSelFadeRightTexture,
                charSelRightPosition,
                Color.White);
        }
    ...
    /// </summary>
    private void DrawPortrait(Player player,
        Vector2 position,
        PlankState plankState)
    {
        switch (plankState)
    ...
    /// </summary>
    private readonly string[] actionList = new string[5]
    {
        "Attack",
        "Spell",
        "Item",
    ...
    public void UpdateActionsMenu()
    {
        ...
        if (InputManager.IsActionTriggered(InputManager.Action.Ok))
        {
            switch (actionList[highlightedAction])
            {
                ...
                case "Spell":
                {
                    var spellbookScreen = new SpellbookScreen(
    ...
    /// </summary>
    private void spellbookScreen_SpellSelected(Spell spell)
    {
        if (spell != null)
        {
    ...
    /// </summary>
    private void inventoryScreen_GearSelected(Gear gear)
    {
        var item = gear as Item;
        if (item != null)
        {
    ...
    private void DrawActionsMenu(Vector2 position)
    {
        ...
        arrowPosition.X += 10f;
        arrowPosition.Y += 2f;
        arrowPosition.Y += height * highlightedAction;
