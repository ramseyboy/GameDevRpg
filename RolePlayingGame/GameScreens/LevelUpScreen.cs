...
/// </summary>
internal class LevelUpScreen : GameScreen
{
    private int index;
    private readonly List<Player> leveledUpPlayers;
    private readonly List<Spell> spellList = new();
    ...
    private Color color;
    private readonly Color colorName = new(241, 173, 10);
    private readonly Color colorClass = new(207, 130, 42);
    private readonly Color colorText = new(76, 49, 8);
    ...
    public LevelUpScreen(List<Player> leveledUpPlayers)
    {
        ...
        Exiting += LevelUpScreen_Exiting;
    }


    private void LevelUpScreen_Exiting(object sender, EventArgs e)
    {
    ...
    public override void LoadContent()
    {
        ...
        titlePosition.X = (screenSize.X -
                           Fonts.MainFont.MeasureString(titleText).X) / 2;
    ...
    private void GetSpellList()
    {
            ...
            leveledUpPlayers[index].CharacterClass.LevelEntries.Count)
        {
            ...
            else
            {
                ...
                {
                    return !newSpells.Exists(delegate(Spell newSpell) { return spell.AssetName == newSpell.AssetName; });
                });
                startIndex = 0;
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        var currentIconPosition = iconPosition;
        var currentLinePosition = linePosition;
        var currentLevelPosition = levelPosition;
        ...
        {
            // Draw the spell icon
            spriteBatch.Draw(spellList[i].IconTexture,
                currentIconPosition,
                Color.White);
    ...
    {
        var position = topLinePosition;
        var posDamage = playerDamagePosition;
        var player = leveledUpPlayers[index];
        var level = player.CharacterLevel;
        var levelingStatistics =
        ...
        spriteBatch.DrawString(Fonts.MainFont,
            "PO: " +
            player.CurrentStatistics.PhysicalOffense,
            posDamage,
            color);

        // Draw the physical defense
        posDamage.Y += Fonts.MainFont.LineSpacing;
        ...
        spriteBatch.DrawString(Fonts.MainFont,
            "PD: " +
            player.CurrentStatistics.PhysicalDefense,
            posDamage,
            color);
        ...
        spriteBatch.DrawString(Fonts.MainFont,
            "MO: " +
            player.CurrentStatistics.MagicalOffense,
            posDamage,
            color);
        ...
        spriteBatch.DrawString(Fonts.MainFont,
            "MD: " +
            player.CurrentStatistics.MagicalDefense,
            posDamage,
            color);
    }
