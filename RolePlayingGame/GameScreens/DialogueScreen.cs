...
namespace RolePlaying
{
    ...
    class DialogueScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.DrawString(Fonts.MainFont, dialogueList[i],
            ...
            {
                spriteBatch.DrawString(Fonts.MainFont, backText, backPosition,
                    Color.White);
            ...
            if (!String.IsNullOrEmpty(selectText))
            {
                selectPosition.X = selectButtonPosition.X -
                    Fonts.MainFont.MeasureString(selectText).X - 10f;
                selectPosition.Y = selectButtonPosition.Y;
                spriteBatch.DrawString(Fonts.MainFont, selectText, selectPosition,
                    Color.White);
