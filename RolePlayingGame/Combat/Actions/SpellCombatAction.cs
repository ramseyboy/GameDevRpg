...
/// </summary>
internal class SpellCombatAction : CombatAction
{
    #region Heuristic
    ...
    public override int Heuristic =>
        Combatant.Statistics.MagicalOffense +
    ...
    public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
    {
        ...
        if (!spell.SpellSprite.IsPlaybackComplete)
        {
            ...
            {
                spell.SpellSprite.Draw(spriteBatch,
                    spellSpritePosition,
                    0f,
        ...
        Spell spell)
    {
        ...
        var magicalOffense = combatant.Statistics.MagicalOffense;
    ...
    {
        var effectStatistics = CalculateSpellDamage(combatant, spell);
    ...
    /// </summary>
    private float projectileDistanceCovered;
    ...
    protected override void StartStage()
    {
        switch (stage)
        {
            ...
            case CombatActionStage.Executing:
            {
                ...
                var damagedAnyone = ApplySpell(Target);
                // apply the spell to the secondary targets
                foreach (var targetCombatant in
        ...
        : base(combatant)
    {
        ...
        this.spell = spell;
        adjacentTargets = this.spell.AdjacentTargets;
    }
