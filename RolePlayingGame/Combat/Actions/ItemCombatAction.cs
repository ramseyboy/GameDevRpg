...
/// </summary>
internal class ItemCombatAction : CombatAction
{
    #region Heuristic
    ...
    public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
    {
        ...
        if (!item.SpellSprite.IsPlaybackComplete)
        {
            ...
            {
                item.SpellSprite.Draw(spriteBatch,
                    itemSpritePosition,
                    0f,
    ...
    {
        var effectStatistics = CalculateItemDamage(combatant, item);
        if (item.IsOffensive)
        {
    ...
    protected override void StartStage()
    {
        switch (stage)
        {
            ...
            case CombatActionStage.Executing:
                ...
                var damagedAnyone = ApplyItem(Target);
        ...
        : base(combatant)
    {
        ...
        this.item = item;
        adjacentTargets = this.item.AdjacentTargets;
    }
