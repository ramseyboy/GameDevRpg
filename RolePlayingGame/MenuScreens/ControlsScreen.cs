...
namespace RolePlaying
{
    ...
    class ControlsScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(Fonts.MainFont, "Back",
            ...
            if (isShowControlPad)
            {
                ...
                {
                    spriteBatch.DrawString(Fonts.MainFont, leftStrings[i].text,
                        leftStrings[i].textPosition, Color.Black);
                }

                for (int i = 0; i < rightStrings.Length; i++)
                {
                    spriteBatch.DrawString(Fonts.MainFont, rightStrings[i].text,
                        rightStrings[i].textPosition, Color.Black);
                }

#if !XBOX
                // Near left trigger
                spriteBatch.DrawString(Fonts.MainFont, "Keyboard",
                ...
                spriteBatch.DrawString(Fonts.MainFont, "Gamepad", titlePosition,
                    Fonts.TitleColor);
            }
            else // draws the keyboard screen
            {
                    ...
                    i++, j++)
                {
                    ...
                    // Draw the action
                    spriteBatch.DrawString(Fonts.MainFont, keyboardString, 
                ...
                spriteBatch.DrawString(Fonts.MainFont, "Action", actionPosition,
                    Fonts.CaptionColor);
                ...
                key1Position.Y = 200;
                spriteBatch.DrawString(Fonts.MainFont, "Key 1", key1Position,
                    Fonts.CaptionColor);
                ...
                key2Position.Y = 200;
                spriteBatch.DrawString(Fonts.MainFont, "Key 2", key2Position,
                    Fonts.CaptionColor);

                // Near left trigger
                spriteBatch.DrawString(Fonts.MainFont, "Gamepad",
                    new Vector2(leftTriggerPosition.X + (leftTriggerButton.Width -
                    Fonts.MainFont.MeasureString("Gamepad").X) / 2,
                ...
                spriteBatch.DrawString(Fonts.MainFont, "Keyboard", titlePosition,
                    Fonts.TitleColor);
