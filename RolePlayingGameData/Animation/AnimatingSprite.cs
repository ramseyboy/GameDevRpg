...
#endif
{
    ...
    public void UpdateAnimation(float elapsedSeconds)
    {
        ...
        var column = (currentFrame - 1) / framesPerRow;
        ...
        while (elapsedTime * 1000f > currentAnimation.Interval)
        {
            currentFrame++;
            elapsedTime -= currentAnimation.Interval / 1000f;
        }
    }
    ...
    public class AnimatingSpriteReader : ContentTypeReader<AnimatingSprite>
    {
        ...
        {
            var animatingSprite = existingInstance;
