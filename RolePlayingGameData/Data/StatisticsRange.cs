...
{
    [ContentSerializer(Optional = true)] public Int32Range HealthPointsRange;

    [ContentSerializer(Optional = true)] public Int32Range MagicPointsRange;

    [ContentSerializer(Optional = true)] public Int32Range PhysicalOffenseRange;

    [ContentSerializer(Optional = true)] public Int32Range PhysicalDefenseRange;

    [ContentSerializer(Optional = true)] public Int32Range MagicalOffenseRange;

    [ContentSerializer(Optional = true)] public Int32Range MagicalDefenseRange;
    ...
    public StatisticsValue GenerateValue(Random random)
    {
        ...
        var outputValue = new StatisticsValue();
    ...
    {
        var outputRange = new StatisticsRange();
    ...
    public class StatisticsRangeReader : ContentTypeReader<StatisticsRange>
    {
        ...
        {
            var output = new StatisticsRange();
