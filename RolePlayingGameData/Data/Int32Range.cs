...
public struct Int32Range
{
    ...
    /// </summary>
    public int Average => Minimum + Range / 2;
    ...
    /// </summary>
    public static Int32Range Add(Int32Range range, int amount)
    {
    ...
    ///     Add an Int32 to both the minimum and maximum values of the range.
    /// </summary>
    public static Int32Range operator +(Int32Range range, int amount)
    {
    ...
    /// </summary>
    public static Int32Range Subtract(Int32Range range, int amount)
    {
        var outputRange = range;
        outputRange.Minimum -= amount;
        outputRange.Maximum -= amount;
