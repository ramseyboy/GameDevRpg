...
{
    [ContentSerializer(Optional = true)] public int HealthPoints;

    [ContentSerializer(Optional = true)] public int MagicPoints;

    [ContentSerializer(Optional = true)] public int PhysicalOffense;

    [ContentSerializer(Optional = true)] public int PhysicalDefense;

    [ContentSerializer(Optional = true)] public int MagicalOffense;

    [ContentSerializer(Optional = true)] public int MagicalDefense;
    ...
    /// </summary>
    public StatisticsValue(int healthPoints,
        int magicPoints,
        int physicalOffense,
        int physicalDefense,
        int magicalOffense,
    ...
    public class StatisticsValueReader : ContentTypeReader<StatisticsValue>
    {
        ...
        {
            var output = new StatisticsValue();
