...
public class CharacterClass : ContentObject
{
    ...
    public class CharacterClassReader : ContentTypeReader<CharacterClass>
    {
        ...
        {
            var characterClass = existingInstance;
    ...
    /// </summary>
    private StatisticsValue initialStatistics;
    ...
    public StatisticsValue GetStatisticsForLevel(int characterLevel)
    {
        ...
        var output = initialStatistics;

        // add each level of leveling statistics
        for (var i = 1; i < characterLevel; i++)
        {
    ...
    public List<Spell> GetAllSpellsForLevel(int characterLevel)
    {
        ...
        for (var i = 0; i < characterLevel; i++)
        {
            ...
            foreach (var spell in levelEntries[i].Spells)
            {
                var existingSpell = spells.Find(
                    delegate(Spell testSpell) { return spell.AssetName == testSpell.AssetName; });
