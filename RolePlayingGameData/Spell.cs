...
#endif
{
    ...
    /// </remarks>
    private StatisticsRange targetEffectRange = new();
    ...
    public StatisticsRange TargetEffectRange => targetEffectRange;
    ...
    ///     This is a debuff if IsOffensive is true, otherwise it's a buff.
    /// </remarks>
    private StatisticsRange initialTargetEffectRange = new();
    ...
    /// </summary>
    private StatisticsValue levelingProgression;
